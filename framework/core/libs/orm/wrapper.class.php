...
class OrmWrapper {
	 ...
	 * Define the table name. Define the id column
	 */
	...
	private function buildSelectStart() {
		...
		$resultColumns = $this->_distinct ? "DISTINCT $table.$resultColumns" : "$table.$resultColumns";
	 ...
	 *
	 * @param array $data
	 *        	data to be insert in the model
	 * @return \OrmWrapper
	 */
