...
class ArkCategory extends Model {
	...
	function createCategory($title ,$tags,$source,$category_id,$blog_content) {
	...
	function modifyCategory($id,$user_id,$title ,$tags,$source,$category_id,$blog_content) {
	...
	function getCatetory($article_id){
